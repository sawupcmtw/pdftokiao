...
import { type ShortAnswerQuestion } from '../../core/schemas/index.js';
declare const ShortAnswerParserInputSchema: z.ZodObject<{
...
export declare function parseShortAnswer(payload: ShortAnswerParserInput): Promise<ShortAnswerParserResult>;
export {};
//# sourceMappingURL=short-answer.task.d.ts.map